...
import com.allegrorom.ota.FetchRomInfoTask.RomInfoListener;
...
public class OTAUpdaterActivity extends PreferenceActivity {
    protected static final String NOTIF_ACTION = "com.allegrorom.ota.action.NOTIF_ACTION";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!Utils.isROMSupported()) {
            ...
            final Preference author = findPreference("author_view");
            author.setSummary("GoldRenard");
            homepagePref = findPreference("homepage_view");
            homepagePref.setSummary("Lenovo-Forums.ru");
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == homepagePref) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://lenovo-forums.ru/topic/2996-customromallegrorom-для-lenovo-a516/")));
            return true;
        }
        return false;
    }
